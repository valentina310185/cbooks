	...
	{			
		...
		else
		{
			...
			foreach($menus as $menu)
			{
				...
				?>
				<a href="<?=$menu["menu_url"]?>?class_name=<?=$menu["class_name"]?>&function_name=<?=$menu["function_name"]?>" class="col-sm-4 col-xs-12 btn btn-md <?=$menu["menu_class"]?> <?=$menu["menu_flag"]?>" target="<?=$menu["menu_target"]?>" <?=$menu["menu_attributes"]?>>
	...
	{			
		...
		else
		{
			...
			foreach($menus as $menu)
			{
				eval("?>" . $menu["menu_above_menu_code"]);
				?>
				<a href="<?=$menu["menu_url"]?>?class_name=<?=$menu["class_name"]?>&function_name=<?=$menu["function_name"]?>" class="btn btn-lg btn-block <?=$menu["menu_class"]?> <?=$menu["menu_flag"]?>" target="<?=$menu["menu_target"]?>" <?=$menu["menu_attributes"]?>>
					<i class="fa fa-4x <?=$menu["menu_icon"]?>"></i>
					<br>
					<?=$menu["menu_name"]?>
				</a>
		...
		else
		{
			...
			<div id="menu_<?=$menus_groups_name?>" class="row">
				...
				foreach($menus as $menu)
				{
					eval("?>" . $menu["menu_above_menu_code"]);
					?>
					<a href="<?=$menu["menu_url"]?>?class_name=<?=$menu["class_name"]?>&function_name=<?=$menu["function_name"]?>" class="list-group-item <?=$menu["menu_class"]?> <?=$menu["menu_flag"]?>" target="<?=$menu["menu_target"]?>" <?=$menu["menu_attributes"]?>>
		...
		else
		{
			...
			<div id="menu_<?=$menus_groups_name?>" class="row">
				...
				foreach($menus as $menu)
				{
					eval("?>" . $menu["menu_above_menu_code"]);
					?>
					<a href="<?=$menu["menu_url"]?>?class_name=<?=$menu["class_name"]?>&function_name=<?=$menu["function_name"]?>" class="btn <?=$menu["menu_class"]?> <?=$menu["menu_flag"]?>" target="<?=$menu["menu_target"]?>" <?=$menu["menu_attributes"]?>>
						<i class="fa <?=$menu["menu_icon"]?>"></i> 
						<?=$menu["menu_name"]?>
					</a>
					<?php
			...
			<div id="menu_<?=$menus_groups_name?>" class="row">
				<div class="btn-group">
					...
					foreach($menus as $menu)
					{
						...
						?>
						<li>
							<a href="<?=$menu["menu_url"]?>?class_name=<?=$menu["class_name"]?>&function_name=<?=$menu["function_name"]?>" class="<?=$menu["menu_flag"]?>" target="<?=$menu["menu_target"]?>" <?=$menu["menu_attributes"]?>>
								<i class="fa <?=$menu["menu_icon"]?>"></i> 
								<?=$menu["menu_name"]?>
							</a>
						</li>
